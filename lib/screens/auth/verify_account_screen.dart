...
class VerifyAccountScreen extends StatefulWidget {
  ...
  const VerifyAccountScreen({Key? key, required this.mobile}) : super(key: key);
...
class _VerifyAccountScreenState extends State<VerifyAccountScreen> {
    ...
    return Scaffold(
      ...
      body : ListView(
        ...
        children: [
          ...
          TextApp(text: "${ AppLocalizations.of(context)?.sub_title_verify ?? ""} +970XXXXXXXXX", height: 2 ,fontSize: 14, fontColor: AppColor.SUB_TITLE_PAGEVIEW, fontWeight: FontWeight.w500,),
  ...
  Future verify() async{
    ...
    bool active  = await UserApiController().activeAccount(getCode(), widget.mobile);
