...
import 'package:project2/screens/auth/verify_code_screen.dart';
...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen>
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          TextApp(
            text: AppLocalizations.of(context)?.sub_title_forget ?? "",
            height: 2,
            fontSize: 14,
  ...
  Future forgetPassword() async {
    bool status = await UserApiController()
        .forgetPassword(context, mobile: _mobileTextEditingController.text);
    if (status) {
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) =>
                  VerifyCodeScreen(mobile: _mobileTextEditingController.text)));
    }
  }
}
